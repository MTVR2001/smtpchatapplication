...
Label_0=Label(root, text="Credentials", width=20, fg="green", font=("bold",20))
...
Label_7=Label(root, text="", width=80, font=("bold",10))
...
try:
        email_send = ['enter_recipients_name1@gmail.com','enter_recipients_name2@gmail.com','enter_recipients_name3@gmail.com']
        for RECIPIENTS in email_send:
            print (RECIPIENTS)
            ...
            server.sendmail(str(Rmail.get()), RECIPIENTS, text)
